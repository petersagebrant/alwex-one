...
const kpiSelect =
  "id, business_area_id, name, category, target_value, current_value, unit, status, trend, direction, tolerance_type, green_tolerance, yellow_tolerance, created_at, updated_at";
